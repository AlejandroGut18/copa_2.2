...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="<?php echo base_url; ?>Materia"><i class="app-menu__icon fa fa-calendar"
                        style="color: #ffffff;"></i><span class="app-menu__label">Calendario</span></a></li>
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a class="treeview-item" href="<?php echo base_url; ?>Inscripciones/InscripcionJugadores">
                            ...
                            <span style="font-size: 14px;">Inscribir Jugadores</span>
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a class="treeview-item" href="<?php echo base_url; ?>Jugadores">
                            ...
                            <span style="font-size: 14px;">Asignación</span>
                        </a>
                    </li>
                </ul>
            </li>
