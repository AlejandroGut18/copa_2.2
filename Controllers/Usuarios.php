...
class Usuarios extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            if ($data[$i]['status_id'] == 1) {
                ...
                <span class="badge-primary p-1">Super Admin</span>
                <button class="btn btn-edit" type="button" onclick="btnEditarUser(' . $data[$i]['id'] . ');"><i class="fa fa-pencil-square-o"></i></button>
                </div>';
                }
            } else {
    ...
    public function permisos($id)
    {
        ...
        echo '</div>
        <button class="btn btn-updatee mt-3 btn-block" type="button" onclick="registrarPermisos(event);">Actualizar</button>';
        die();
    }
